...
Notice how the scores for each cell depend on the composition of the dataset? It might not matter depending on what you want to do, but it's good to about anyway. 
